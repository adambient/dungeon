...
.\pasmo\pasmo.exe --name raw --tap .\pasmo\main.asm pasmo.build.tap
...
type loader.build.tap pasmo.build.tap main.build.tap bank3.build.tap gfx.build.tap > labyrinth.tap
